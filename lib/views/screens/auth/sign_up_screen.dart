...
//                       text: 'Sign Up',
//                       onPressed: () {
//                         context.go("/${RouteGenerate.loginScreen}");
//                       },
//                     ),
//                     GapWidget(
//                       size: -5,
...
class SignUpScreen extends StatelessWidget {
  ...
  Widget _buildContainer(BuildContext context) {
    return Container(
                  ...
                  Row(
                    children: <Widget>[
                      Flexible(
                        flex: 1,
                        child: CustomTextFormField()
                            .SimpleTextFormField(hintText: "First Name", context: context),
                      ),
                      GapWidget(
                        size: -5,
                      ),
                      Flexible(
                        flex: 1,
                        child: CustomTextFormField()
                            .SimpleTextFormField(hintText: "Last Name", context: context),
                      ),
                    ],
                  ),
                  GapWidget(),
                  CustomTextFormField().SimpleTextFormFieldWithPrefixIcon(
                      hintText: "Email", prefixIcon: Icons.email, context: context),
                  GapWidget(),
                  CustomTextFormField().SimpleTextFormFieldWithPrefixIcon(
                      hintText: "Password", prefixIcon: Icons.lock, context: context),
                  GapWidget(),
                  CustomButton(
                    text: 'Sign Up',
                    onPressed: () {
      ...
      style: CustomTextTheme.getTextStyle(MyTextStyle.SimpleText, context),
                          // style: TextStyle(
                          //   color: Color(0xFF666666),
                          //   fontFamily: defaultFontFamily,
                          //   fontSize: defaultFontSize,
