...
// class ChangePassScreen1 extends StatelessWidget {
//   const ChangePassScreen1({super.key});
...
//                         hintText: "Old Password", prefixIcon: Icons.lock),
//                     GapWidget(size: 10),
//                     CustomTextFormField().SimpleTextFormFieldWithPrefixIcon(
...
//                         context.go(
//                             "/${RouteGenerate.homeScreen}"); //  /home_screen");
//                       },
//                     ),
//                     GapWidget(
//                       size: -5,
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                // Text("Login"),
                CustomTextFormField().SimpleTextFormFieldWithPrefixIcon(
                        hintText: "Old Password", prefixIcon: Icons.lock, context: context),
                    GapWidget(size: 10),
                    CustomTextFormField().SimpleTextFormFieldWithPrefixIcon(
                        hintText: "New Password", prefixIcon: Icons.lock, context: context),
                    GapWidget(size: 10),
                    CustomTextFormField().SimpleTextFormFieldWithPrefixIcon(
                        hintText: "New Password", prefixIcon: Icons.lock, context: context),
                    GapWidget(size: 10),
